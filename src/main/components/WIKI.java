...
public class WIKI {
    ...
    public void createUIComponents() {
        ...
        nodes = Arrays.asList(
                ...
                new Node("Compiler", Arrays.asList(
                        new Node("IntelliJ", "general handling"),
                        new Node("Artifact", "how to create and handle")
                ))
        );
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (selRow != -1) {
                    if (e.getClickCount() == 1) {
                        ...
                        // Compiler and Go
                        ////////////////////////////////////////////////////////////////////////////////////////////////
                        if (node != null && node.getUserObject().equals("IntelliJ")) {
                            //CallableAndFuture.start();
                            // opens a HTML file on the editPane
                            File file = new File("src\\Compiler\\Compiler\\IntelliJ.html");
                            editPane.setEditable(false);
                            try {
                                // Load the HTML file
                                URL url = new URL("file:///"+file.getAbsolutePath());
                        ...
                        } else if (node != null && node.getUserObject().equals("Artifact")) {
                            //DeadLock.start();
                            // opens a HTML file on the editPane
                            File file = new File("src\\Compiler\\Compiler\\Artifact.html");
                            editPane.setEditable(false);
                            try {
                                // Load the HTML file
                                URL url = new URL("file:///" + file.getAbsolutePath());
        ...
        SDBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                File file = new File("src\\main\\content\\SoftwareDev.html");
                editPane.setEditable(false);
                try {
                    // Load the HTML file
                    URL url = new URL("file:///"+file.getAbsolutePath());
        ...
        SSBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                File file = new File("src\\main\\content\\SoftwareSecure.html");
                editPane.setEditable(false);
                try {
                    // Load the HTML file
                    URL url = new URL("file:///"+file.getAbsolutePath());
